 ...
 */
public class HybridNormal extends HybridT {

	private final ClusterBidder normal;
	
	public HybridNormal(BufferHolder bh, PaymentSender ps, ItemSender is, AuctionHouse ah, UserRecord ur,
		...
		return new AgentAdder() {
			...
			public void add(BufferHolder bh, PaymentSender ps, ItemSender is, AuctionHouse ah, UserRecord ur, ArrayList<ItemType> types) {
				for (int i = 0; i < numberOfAgents; i++) {
					HybridNormal sc = new HybridNormal(bh, ps, is, ah, ur, types, strategy);
